package com.freakybyte.accedo.ui.material;
...
public abstract class Button extends CustomView {
    ...
    protected void setDefaultProperties() {
        // Min size
        setMinimumHeight(AndroidUtil.dpToPx(minHeight, getResources()));
        setMinimumWidth(AndroidUtil.dpToPx(minWidth, getResources()));
        // Background shape
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(
                getWidth() - AndroidUtil.dpToPx(6, getResources()), getHeight()
                        - AndroidUtil.dpToPx(7, getResources()), Bitmap.Config.ARGB_8888);
